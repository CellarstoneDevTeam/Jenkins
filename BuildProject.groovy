...
stage(QCVSSProjectFolder + ' Get Source from VSS')
    { 
     ...
     stage('Compile Project and Copy DLLS')
     {
	    ...
	    bat '\"%DigitalSignPath%\\signtool\" sign /f \"%DigitalSignPath%\\mypfxfile.pfx\" /p %DigitalSignPassword% /t http://timestamp.verisign.com/scripts/timstamp.dll \"' + dllpath +"\\" + assembly   		
